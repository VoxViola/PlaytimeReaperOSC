# PlaytimeReaperOSC
This is a small project built in Open Stage Control that works with Playtime 2 and Realearn in Reaper, to control clip launching, and intended to be used with an iPad. It must be paired with custom settings available for download on the projects page of my website www.trevornew.com
...
4. connect via data usb cable

There are many more ways to do this but see Open Stage Control and Reaper installation instructions.

Let me know if you have any questions here or on instagram @VoxViola
Thanks!
